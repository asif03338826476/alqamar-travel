...
const Home: NextPage = () => {
  ...
  const Map = dynamic(() => import("../components/Map.jsx") as any, {
    ssr: false,
  });
  ...
  return (
    <div>
      ...
      <div
        id="heading"
        className="bg-[url('../public/imgs/lace.jpg')] bg-contain h-[80px] w-full "
      ></div>
      <div className="my-20">
        <div
          ref={heading.ref}
          className={`${
            heading.inView
              ? "translate-y-[0vh] opacity-1"
              : "translate-y-[10vh] opacity-0"
          } transition-all duration-1000 ease-out `}
        >
          <h4 className="text-xs lg:text-sm font-heading my-5 text-center w-full tracking-[10px] font-semibold">
            POPULAR ACTIVITIES
          </h4>
          <h3 className="text-3xl lg:text-4xl my-5 tracking-wide w-full text-center capitalize font-extrabold">
            Most popular activities in pakistan
          </h3>
        </div>
        {/* <Map/> */}
        <div
          id="tours"
          ref={cards.ref}
          className={`flex flex-wrap justify-center transition-all duration-[1500ms] ease-out ${
            cards.inView ? "opacity-100" : "opacity-0"
          } `}
        >
          <CardItem
            ...
            modalDesc={pakDesc}
            title="experience"
            desc="Explore the beauty of Pakistan with us today"
            img={img1}
          />
          <CardItem
            ...
            modalDesc={pakDesc}
            title="relax"
            desc="Indulge in the relaxing atmosphere"
            img={img2}
          />
          <CardItem
            icon={<LandscapeIcon />}
            modalDesc={pakDesc}
            title="embrace"
            desc="Let the scenery take your breath away"
            img={img3}
          />
        </div>
      </div>
      <div className="mt-40 relative">
        ...
        >
          <h4 className="text-xs lg:text-sm font-heading my-10 text-center w-full tracking-[10px] font-semibold">
            TOUR DESTINATIONS
          </h4>
          <h3 className="text-3xl lg:text-4xl my-10 tracking-wide w-full text-center capitalize font-extrabold">
            Top tour destinations in pakistan
          </h3>
        </div>
        <div className="flex flex-wrap justify-center mt-[150px]">
          <div
            ...
            className={`transition-all duration-1000 ${
              bigCard.inView ? "opacity-100 scale-100" : "opacity-0 scale-0"
            }`}
          >
            <BigCard />
          </div>
          <div
            id="guide"
            ref={accordions.ref}
            className={`flex flex-col transition-all duration-[2000ms] ease-in-out ${
              accordions.inView
                ? "translate-y-[0vh] opacity-100"
                : "translate-y-[20vh] opacity-0"
            } `}
          >
            <AccordionCard
              title={"Neelum Valley"}
              price={"12000"}
              desc={"An exquisite tour of the Neelum valley"}
              img={mountains}
            />
            <AccordionCard
              title={"French Beach"}
              price={"15000"}
              desc={"Go swimming in the beautiful deep blue"}
              img={beach}
            />
            <AccordionCard
              title={"Swat River"}
              price={"18000"}
              desc={"Flowing from the glaciers of Hindi Kush"}
              img={river}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="max-w-[400px]">
              Looking for an experience like never before? Book your tour with
              us today and let us contact you.
            </p>
            <input
              required
              type="text"
            ...
            <input
              ...
              className="px-4 py-2 transition-all  text-black shadow-md w-full rounded-2xl placeholder:italic focus:outline-none border-2 border-transparent hover:border-primary focus:border-primary bg-stone-100 my-4"
            />
            <button className="my-4 px-6 py-2 rounded-2xl bg-secondary hover:bg-secondaryLighter text-white font-medium">
              Submit
            </button>
            <Alert
              className={`w-full ${showAlert ? "block" : "hidden"}`}
              severity="success"
            >
